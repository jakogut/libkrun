...
* **GPU=1**: Enables virtio-gpu. Requires virglrenderer-devel. Fixed-address resource mapping is used automatically when virglrenderer exports `virgl_renderer_resource_map_fixed` and can be queried with `KRUN_FEATURE_VIRGL_RESOURCE_MAP_FIXED`.
